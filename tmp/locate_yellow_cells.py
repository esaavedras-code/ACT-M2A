...
print(f"Yellow cells in CML Report:")
for r in range(1, 220):
    for c in range(1, 25):
        cell = ws.cell(row=r, column=c)
        if cell.fill and cell.fill.start_color and cell.fill.start_color.rgb == 'FFFFFF00':
            # Identify label
            # Often labels are to the left, or sometimes the cell itself has a placeholder if it's value-less
            ...
            # Print row, col, coordinate, current value and labels
