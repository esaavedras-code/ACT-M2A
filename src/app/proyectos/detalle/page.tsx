    ...
    return (
        <div className="py-2 animate-in fade-in duration-500">
            ...
            <div className="flex flex-col lg:flex-row gap-8 items-start relative">
                ...
                <div className="lg:fixed lg:top-[160px] lg:left-[max(2rem,calc(50%-600px))] z-[40] w-full lg:w-[280px] shrink-0 transition-all duration-300">
                ...
                <div className="flex-1 w-full min-w-0 lg:ml-[312px]">
