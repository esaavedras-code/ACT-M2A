...
const LoginPage: NextPage = () => {
    ...
    const handleForgotPassword = async () => {
        ...
        try {
            ...
            alert("✓ Se ha enviado una contraseña temporal a tu correo electrónico. Revisa tu bandeja de entrada (y spam) y usa esa contraseña para iniciar sesión.");
        } catch (err: any) {
                ...
                <div className="bg-white dark:bg-slate-800 rounded-[2rem] shadow-2xl overflow-hidden border border-slate-200 dark:border-slate-700">
                    <div className="bg-primary p-8 text-center relative overflow-hidden">
                        <div className="relative z-10">
                            ...
                            <p className="text-blue-100 mt-2 font-medium">PROYECTOS ACT</p>
                        </div>
