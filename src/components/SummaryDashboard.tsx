            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                ...
                <div className="card border-t-4 border-t-emerald-500">
                    ...
                    <div className="space-y-1">
                        ...
                        <MetricRow label="Certified to date (WP) (Ejecutado)" value={formatCurrency(metrics.cost.certTotal)} color="text-emerald-700" tooltip="Monto total certificado para pago hasta la fecha según el Work Performed (WP)." />
