...
export default function Reportes2Menu() {
    ...
    // Reutilizar lógica de hover de ReportesMenu.tsx
    ...
    return (
        ...
        >
            <button
                className={`flex items-center gap-2 px-3 py-1.5 rounded-lg transition-all duration-300 font-bold text-sm uppercase tracking-wider ${isOpen
            ...
            {isOpen && (
                <div className="absolute left-0 mt-2 w-[320px] z-[100] animate-in fade-in zoom-in-95 duration-200">
                    <div className="bg-white dark:bg-slate-900 rounded-2xl shadow-[0_20px_50px_rgba(0,0,0,0.2)] border border-slate-100 dark:border-slate-800 overflow-hidden ring-1 ring-black/5">
                        <div className="bg-slate-50 dark:bg-slate-800/50 px-5 py-3 border-b border-slate-100 dark:border-slate-800 flex justify-between items-center">
                            <span className="text-[10px] font-black text-slate-400 uppercase tracking-[0.2em]">Generador de Reportes (V2)</span>
                            {!projectId && (
